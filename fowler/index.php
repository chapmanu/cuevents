...
<?php include "../includes/header.php" ?>
      ...
      <div class="container-fluid bg-dark">
        <div class="container pt-3 pb-3">
          <div class="row">
            <div class="col-md-9">
              <h1 class="text-white"><a href="<?php echo $baseUrl.'/fowler/index.php' ?>">Fowler School of Engineering Events </a></h1>
            </div>
            <div class="col-md-3">
    ...
    <?php
    $calendarWebName = 'engineering-event-calendar';
    $teaserBase = $baseUrl . '/fowler/index.php';
