...
?>
      ...
      <div class="container-fluid bg-dark test-1">
        <div class="container pt-3 pb-3">
          <div class="row">
            <div class="col-md-9">
              <h1 class="text-white"><a href="<?php echo $baseUrl.'/attallah/index.php' ?>">Attallah College of Educational Studies </a></h1>
            </div>
            <div class="col-md-3">
    ...
    <?php
    $calendarWebName = 'attallah-event-calendar';
    $teaserBase = $baseUrl . '/attallah/index.php';
