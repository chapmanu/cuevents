...
<?php include "../includes/header.php" ?>
      ...
      <div class="container-fluid bg-dark">
        <div class="container pt-3 pb-3">
          <div class="row">
            <div class="col-md-6">
              <h1 class="text-white"><a href="/calendar/communication/index.php">School of Communication Events </a></h1>
            </div>
            <div class="col-md-6">
      ...
      <div class="container">
        <div class="row pt-4">
          ...
          <div class="col-md-3">
            ...
            <label> Search & Filter Communication Events </label>
            <div id="search">
            </div>
    ...
    <script type="text/javascript">
       $Trumba.addSpud({
          webName: "communication-event-calendar",
        ...
        webName: "communication-event-calendar",
        spudType : "datefinder" ,
        teaserBase : "/calendar/communication/index.php",
        spudId: "dates" });
