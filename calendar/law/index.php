...
<?php include "../includes/header.php" ?>
      ...
      <div class="container-fluid bg-dark">
        <div class="container pt-3 pb-3">
          <div class="row">
            <div class="col-md-6">
              <h1 class="text-white"><a href="/calendar/law/index.php">Dale E. Fowler School of Law Events </a></h1>
            </div>
            <div class="col-md-6">
      ...
      <div class="container">
        <div class="row pt-4">
          ...
          <div class="col-md-3">
            ...
            <label> Search & Filter Law Events </label>
            <div id="search">
            </div>
    ...
    <script type="text/javascript">
       $Trumba.addSpud({
        ...
        webName: "law-event-calendar",
        spudType : "datefinder" ,
        teaserBase : "/calendar/law/index.php",
        spudId: "dates" });
