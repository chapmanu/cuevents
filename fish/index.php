...
<?php include "../includes/header.php" ?>
      ...
      <div class="container-fluid bg-dark">
        <div class="container pt-3 pb-3">
          <div class="row">
            <div class="col-md-6">
              <h1 class="text-white"><a href="<?php echo $baseUrl.'/fish/index.php' ?>">Fish Interfaith Center Events </a></h1>
            </div>
            <div class="col-md-6">
    ...
    <script type="text/javascript">
       $Trumba.addSpud({
          webName: "fish-interfaith-center-calendar",
        ...
        webName: "fish-interfaith-center-calendar",
        spudType : "datefinder" ,
        teaserBase : "<?php echo $baseUrl.'/fish/index.php' ?>",
        spudId: "dates" });
